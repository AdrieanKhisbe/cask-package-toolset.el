...
*** Options
+ In case your =origin= remote is not targeting your github repositery, you can specify
  it with the =-r <remote>= or =--remote <remote>= option
+ You could otherwise directly specify your repositeryname with the =-g= or =--github-repo=
...
for you'll just have to add to the [[https://github.com/milkypostman/melpa][melpa repositery]].
